...
namespace NeiroNet1
{
    class NeiroGraphUtils
    {
        ...
        /// Очищает picturebox
        /// </summary>
        /// <param name="pictureBox">Массив данных изображения</param>
        ...
        /// <summary>
        /// Преобразует изображение в двумерный массив целых чисел (0 и 1).
        /// </summary>
        /// <param name="image">Битемап изображения</param>
        /// <param name="message">Флаг для ошибки, если изображения нет</param>
        ...
        /// <summary>
        /// Рисует указанную литеру на изображении
        /// </summary>
        /// <param name="bmp">Битемап изображения</param>
        /// <param name="l">Строка для рисования</param>
        /// <returns>Результат обработки</returns>
        ...
        /// <summary>
        /// Преобразует двумерный массив целых чисел в изображение.
        /// </summary>
        /// <param name="array">Двумерный массив изображения</param>
        /// <returns>Результат обработки</returns>
        ...
        /// <summary>
        /// Вырезает часть изображения и преобразует ее в двумерный массив целых чисел
        /// </summary>
        /// <param name="b">Изображение, из которого нужно вырезать</param>
        /// <param name="max">Максимальный размер вырезаемой части</param>
        /// <returns>Результат обработки</returns>
        ...
        /// <summary>
        /// Увеличивает двумерный массив целых чисел до указанного размера
        /// </summary>
        /// <param name="source">Исходный двумерный массив</param>
        /// <param name="res">Получившийся двумерный массив</param>
        /// <returns>Результат обработки</returns>
